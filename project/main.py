...
def build_simulation(): 
    ...
    actions, pathways, threshold_matrix, transition_matrix = initialize_simulation(Action, Pathway, NUM_PATIENTS, NUM_PATHWAYS, NUM_ACTIONS, BASE_CAPACITY, IDEAL_CLINICAL_VALUES,INPUT_ACTIONS, OUTPUT_ACTIONS)
